...
export const Hero = () => {
  ...
  <section className=" relative pt-32 lg:pt-36">
    ...
    <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
      ...
      <span className="absolute -left-6 md:left-4 top-24 lg:top-28 w-24 lg:top-28 w-24 h-24 rotate-90 skew-x-12 rounded-3xl bg-gradient-to-r from-blue-600 to-violet-600 blur-xl opacity-60 lg:opacity-95 lg:block hidden">
      ...
      <div className="relative flex flex-col items-center text-center lg:text-left lg:py-8 lg:items-start lg:max-w-none max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2">
        <h1 className="text-heading-1 text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold">
          Automatize Seu Negócio{""}<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-violet-600 ml-2">com IA</span>
        </h1>
        <Paragraph className="mt-8">
        Nossa plataforma SaaS com IA se integra perfeitamente aos seus fluxos de trabalho existentes, oferecendo insights em tempo real, automações inteligentes e decisões orientadas por dados.
        Viva o futuro onde seu negócio opera de forma mais inteligente, ágil e eficiente.
        </Paragraph>
        <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0">
          <div className="flex sm:flex-row flex-col gap-5 w-full">
            <form action="#" className="py-1 pl-6 w-full pr-1 flex gap-3 items-center text-heading-3 shadow-lg shadow-box-shadow border border-box-border bg-box-bg rounded-full ease-linear focus-within:bg-body focus-within:border-primary">
                ...
                <input type="email"
                placeholder="luantrabalho49@gmail.com"
